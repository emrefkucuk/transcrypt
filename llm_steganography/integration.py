...
def generate_steganographic_invitation(room_name: Optional[str] = None, custom_prompt: Optional[str] = None) -> Dict[str, Any]:
    """
...
def create_room_with_steganographic_key(custom_prompt: Optional[str] = None) -> Dict[str, Any]:
    """
    ...
    """
    invitation_info = generate_steganographic_invitation(custom_prompt=custom_prompt)
